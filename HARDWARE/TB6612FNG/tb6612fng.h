 ...
 * @LastEditTime: 2022-05-01 10:17:18
...
#define MOTOR_MAX_FORWARD_SPEED 140	 //设置最大前进速度单位RPM
...
#define CAR_JIN_LEFT_RIGHT_DISTANCE 40 - 5 + 15 - HEADTOEND + 6	   //近端转弯后直走距离

#define CAR_ZHONG_STARUGHT_DISTANCE 60 - 5 - 2 - 15 + 15 + HEADTOEND + 15 + 40			   //中端直走距离
#define CAR_ZHONG_STARIGHT_DISTANCE_2 40 - 5 - 5										   //中端直走距离2
...
#define CAR_YUAN_STARIGHT_DISTANCE 40 + 15 + 40									  //远端直走距离
#define CAR_YUAN_STARIGHT_DISTANCE_2 40 - 3 - 8 - 3 + 5							  //远端直走距离2
#define CAR_YUAN_LEFT_RIGHT_DISTANCE 40 - 5 + 15 - HEADTOEND + 3 + 6			  //远端转弯后直走距离
#define CAR_YUAN_STARIGHT_DISTANCE_3 35 - 5 + 7 + 15 - 3						  //远端直走距离3
#define CAR_YUAN_STARIGHT_DISTANCE_4 40											  //远端直走距离4
#define CAR_YUAN_LEFT_RIGHT_DISTANCE_2 40 - 5 + 15 - HEADTOEND + 10				  //远端转弯后直走距离2
#define CAR_YUAN_GOBACK_STARIGHT_DISTANCE_1 60 + 15 + 10 - 3					  //远端返回直走1
#define CAR_YUAN_GOBACK_STARIGHT_DISTANCE_2 60 + 15 + 15 + 15 + 60 + 15 + 15 + 50 //远端返回直走2
